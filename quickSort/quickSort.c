...
bool verboseOn = false; //To turn on the verbose mode send the parameter --verbose or -v when you are compiling (./quickSort --verbose)
...
void menu(){
	int option=0;
    	do{
		printf("\n-------------------------------\n");
		printf("    QUICK SORT :D (Sorting Algorithm)\n");
